...
Номер телефона:
79261234567
Клиент "Локи Одинсон" сохранён с id 1
Доступные купоны:
3) TRICKSTER15 - скидка 15.0%
Введите id купонов через запятую (или нажмите Enter, если купоны не нужны):
3
Введите дату заказа в формате ДД.ММ.ГГГГ (или нажмите Enter, если заказ не нужен):
06.09.2026
Стоимость:
2500.00
Статус:
...
Статус:
NEW
Заказ с ID: 1, от 2026-09-06, на сумму 2500.00 (NEW)
